...
| Search and log indexing | Elasticsearch |
...
| Delivery | Terraform + Helm + ArgoCD + GitHub Actions |
| Observability | Micrometer + OpenTelemetry + Prometheus + Grafana + Jaeger + ELK |
