...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'User role', enum: ['ADMIN', 'EDITOR', 'VIEWER', 'READ_ONLY', 'USER'], required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['ADMIN', 'EDITOR', 'VIEWER', 'READ_ONLY', 'USER']),
    __metadata("design:type", String)
