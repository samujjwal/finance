...
# EPIC O-01: OPERATOR CONSOLE (12 Stories)
...
**Tests**: tenant_config_isolation · cross_tenant_no_access · operator_override · boundary_enforcement · license_type_defaults · config_inheritance · perf_config_load_sub_10ms
...
**Tests**: p1_notification_5min · resolution_communication · pir_workflow · incident_timeline · severity_escalation · multi_tenant_affection · audit_trail
...
# EPIC P-01: PLUGIN CERTIFICATION PROGRAM (11 Stories)
...
# EPIC R-01: REGULATOR PORTAL (10 Stories)
...
**Tests**: query_positions · query_trade_history · query_settlement · query_audit_logs · bs_date_input · export_pdf · export_csv · query_logged · ad_hoc_builder
...
**Tests**: query_submission · deadline_countdown · response_submission · regulator_notification · deadline_escalation · follow_up_question · response_logged · audit_trail
...
# EPIC R-02: INCIDENT RESPONSE (10 Stories)
