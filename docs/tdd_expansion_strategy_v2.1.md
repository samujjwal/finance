...
- W-01 Workflow Orchestration: Workflow engine, approvals
- W-02 Client Onboarding: KYC, risk assessment, account creation
- O-01 Operator Workflows: Runbooks, escalations, incident response
- P-01 Pack Certification: Validation, rejection, certificates
- R-01 Regulator Portal: Access control, evidence views
- R-02 Incident Notification: Detection, clustering, escalation
