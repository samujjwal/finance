...
- CI runs lint, unit tests, contract validation
...
- Monorepo structure
  - Create `services/`, `packages/`, `apps/`, `infra/`, `schemas/`, `packs/`, `tools/`
  - Establish service template for kernel/domain services
- Shared contracts
